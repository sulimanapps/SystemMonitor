...
struct StatusMenuView: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    Label("Documentation | التوثيق", systemImage: "book.fill")
                        .font(.subheadline.weight(.semibold))

                    HStack(spacing: 12) {
                        Button(action: {
                            openDocumentationFile("BUGS.md")
                        }) {
                            VStack(spacing: 2) {
                        ...
                        Button(action: {
                            openDocumentationFile("VERSION.md")
                        }) {
                            VStack(spacing: 2) {
    ...
    private func openDocumentationFile(_ filename: String) {
        let path = NSHomeDirectory() + "/Desktop/SystemMonitor/" + filename
